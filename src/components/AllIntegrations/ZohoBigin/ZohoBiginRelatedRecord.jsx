      ...
      {biginConf.default?.moduleData?.[biginConf.relatedlists?.[tab - 1]?.module]?.fields
        && (
          <>
            ...
            <div className="txt-center  mt-2" style={{ marginRight: 85 }}><button onClick={() => addFieldMap(biginConf.relatedlists[tab - 1].field_map.length, biginConf, setBiginConf, false, tab)} className="icn-btn sh-sm" type="button">+</button></div>
            <br />
            <br />
            {Object.keys(biginConf.default?.moduleData?.[biginConf.relatedlists[tab - 1].module]?.fileUploadFields).length !== 0 && (
              <>
                ...
                <div className="txt-center  mt-2" style={{ marginRight: 85 }}><button onClick={() => addFieldMap(biginConf.relatedlists[tab - 1].upload_field_map.length, biginConf, setBiginConf, true, tab)} className="icn-btn sh-sm" type="button">+</button></div>
                <br />
                <br />
              </>
            )}
